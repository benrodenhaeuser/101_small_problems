...
// approach:
// -- replace every match with the desired format
// -- replace function



function searchWord(word, text) {
  var wordPattern = RegExp('\\b' + word + '\\b', 'gi');
  var replacement = '**' + word.toUpperCase() + '**';
  var matches = text.replace(wordPattern, replacement);
  return matches;
}

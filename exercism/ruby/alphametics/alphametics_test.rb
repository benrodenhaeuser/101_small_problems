# optimization: example SEND + MORE = MONEY ... we can disregard many permutations, if we proceed efficiently. for example, Y == (D + E) % 10 is a requirement here. this will allow us to dramatically cut down the number of optimizations
